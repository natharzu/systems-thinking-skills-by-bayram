...
|------|------|-------|---------------------------|
| **MEASURED** | green | A hard number from real data, with an n. "66% of created docs have a recipient (n=1,087)." | Is there an actual count/rate behind it? What's the n and the window? |
| **INSTANCE** | amber | A specific observed example, n=1-few. "One builder's doc was born without an assigned signer." | Is this one case (or a handful), not a rate? Don't generalize it. |
...
| **CLAIM** | red | A stakeholder assertion, unverified. "~20 signups/day." | Did a person say it without data? Flag contradictions (e.g. another doc implies ~2/day = 10x gap). |
| **INFERENCE** | purple | Logic built on measured premises. "92% don't agent-send, so the surface is mis-positioned." | Are the premises MEASURED? Is the logical step valid, or is there a hidden third factor? |
| **HYPOTHESIS** | gold-dashed | A testable proposition not yet tested. "Agents finish the binding click in the UI by preference." | Can you name the exact test that would settle it? If not, it's not even a hypothesis. |
...
- MEASURED nodes must state the **n and the window** - "45% (n=1,087, Jun 9-14)", never a bare percentage.
